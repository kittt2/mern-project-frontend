    ...
    <div className="container  p-3 dashboard">
      ...
      <div className="row ">
        ...
        <div className="col col-lg-9 ">
          <h1 className="mb-4 fw-bold text-center" style={{ fontFamily: "Arial, sans-serif", color: "#343a40" }}>Create Product</h1>
          <div className="card mx-5  p-4 shadow-sm border-0 rounded-5">
            <Select
              bordered={false}
              placeholder="Select a category"
              size="large"
              showSearch
              className="form-select mb-3 rounded-pill shadow-sm"
            ...
            <div className="mb-3">
              <label className="btn btn-outline-secondary col-12 rounded-pill shadow-sm">
