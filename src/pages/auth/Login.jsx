      ...
      <div>
        ...
        <div className="row d-flex justify-content-center align-items-center h-100">
          ...
          <div className="col-lg-6 d-none d-lg-block">
            <img src="https://images.unsplash.com/photo-1630673245362-f69d2b93880e?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=1740&q=80" className="img-fluid rounded-5 shadow-sm" alt="Login Banner" />
          </div>
        </div>
      </div>
    </section>
